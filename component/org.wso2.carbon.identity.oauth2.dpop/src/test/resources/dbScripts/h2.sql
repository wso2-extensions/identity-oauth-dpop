...
INSERT INTO IDN_OAUTH2_REFRESH_TOKEN (
    REFRESH_TOKEN_ID, REFRESH_TOKEN, CONSUMER_KEY_ID, AUTHZ_USER, TENANT_ID, USER_DOMAIN, GRANT_TYPE,
    REFRESH_TOKEN_TIME_CREATED, REFRESH_TOKEN_VALIDITY_PERIOD, TOKEN_SCOPE_HASH, TOKEN_STATE,
    SUBJECT_IDENTIFIER, REFRESH_TOKEN_HASH, IDP_ID, CONSENTED_TOKEN, AUTHORIZED_ORGANIZATION
) VALUES (
    'refresh-token-id-123', 'bde76f62-d955-381a-be3b-5adf16abae44', 1, 'admin', 1, 'PRIMARY',
    'authorization_code', CURRENT_TIMESTAMP, 86400, 'dummyScopeHash', 'ACTIVE', 'subject123',
    '{"hash":"75deb4bb4a2f891d5358ec15114670f198f90f4af18146cda2e6c6061e9f33e1","algorithm":"SHA-256"}',
    1, 'true', 'org1'
);

INSERT INTO IDN_OAUTH2_REFRESH_TOKEN_BINDING (
    REFRESH_TOKEN_ID, TOKEN_BINDING_TYPE, TOKEN_BINDING_REF, TOKEN_BINDING_VALUE, TENANT_ID
) VALUES (
    'refresh-token-id-123', 'DPoP', 'bindRef123', 'sampleBindingValue', 1
);
