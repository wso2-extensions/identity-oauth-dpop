...
/**
 * Cache key used to access DPoP JTI Cache Entry.
 */
public class DPoPJTICacheKey extends CacheKey {
    ...
    public DPoPJTICacheKey(String jti, int tenantId) {

        this.jti = jti;
        this.tenantId = tenantId;
    }

    public DPoPJTICacheKey(String jti) {
    ...
    public boolean equals(Object o) {
        ...
        DPoPJTICacheKey that = (DPoPJTICacheKey) o;
